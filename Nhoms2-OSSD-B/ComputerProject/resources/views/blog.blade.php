...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Feb 2023 18:24:47 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="inner">
                            <div class="bradcrumb-thumb">
                                <img src="{{asset('client/assets/images/product/uchiha.png')}}" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row--25">
                    <div class="col-lg-8 axil-post-wrapper">
                        ...
                        <div class="content-blog sticky mt--60">
                            <div class="inner">
                                <div class="content">
                                    <h4 class="title"><a href="#">Giới thiệu Thành Viên</a></h4>
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="{{asset('client/assets/images/blog/author-image-5.png')}}" alt="Author Images">
                                        </div>
                                        <div class="post-meta-content">
                                            ...
                                            <ul class="post-meta-list">
                                                <li>25 02, 2024</li>
                                                <li>Không có gì nổi bật</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <p>
                                        Ongdee CTN là một sinh viên đến từ Lào, sinh viên xuất sắc thuộc lớp Khoa học Máy tính K6B của Đại học Hạ Long.
                                         Với niềm đam mê mãnh liệt đối với công nghệ và khoa học máy tính, 
                                         Bảo đã không ngừng nỗ lực trong việc học tập và nghiên cứu để nâng cao kiến thức và kỹ năng của mình.</p>
                                    <div class="read-more-btn">
                                        <a class="axil-btn btn-bg-primary" href="#">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="axil-post-meta">
                                        ...
                                        <div class="post-meta-content">
                                            ...
                                            <ul class="post-meta-list">
                                                <li>25 02, 2024</li>
                                                <li>siêu cấp vip pro</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <p>
                                        Nguyễn Quốc Bảo là một sinh viên lớp Khoa học Máy tính K6B của Đại học Hạ Long.</p>
                                    <div class="read-more-btn">
                                        <a class="axil-btn btn-bg-primary" href="#">Read More</a>
                                    </div>
                                </div>
                        ...
                        <div class="content-blog sticky mt--60">
                            <div class="inner">
                                <div class="content">
                                    ...
                                    <p>
                                        Hoàng Minh Sơn là một sinh viên lớp Khoa học Máy tính K6B của Đại học Hạ Long.</p>
                                    <div class="read-more-btn">
                                        <a class="axil-btn btn-bg-primary" href="#">Read More</a>
                                    </div>
                                </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Feb 2023 18:24:57 GMT -->
</html>