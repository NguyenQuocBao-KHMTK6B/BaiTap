...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Feb 2023 18:21:13 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="singin-header-btn">
                        ...
                        <a href="{{route("user.showLoginForm")}}" class="axil-btn btn-bg-secondary sign-up-btn">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 offset-xl-2">
                <div class="axil-signin-form-wrap">
                    <div class="axil-signin-form">
                        ...
                        <form class="singin-form" action="{{route('user.signUp')}}" method="POST">
                            @csrf
